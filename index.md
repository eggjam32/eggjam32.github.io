...
Through the code review process and the runtime analysis, I contributed to meeting course outcomes as each is an effective form of communication regarding details of the project to nontechnical and technical audiences. This artifact solves the problem of searching and sorting course information while balancing the tradeoffs between different algorithms, namely BSTs and vectors, ultimately demonstrating a solid understanding and application of data structures and algorithms. This artifact is a clear demonstration of the utilization of different computer science tools, techniques, and skills to deliver the industry-specific goal of developing a system that achieves the searching and sorting desired by ABCU University. Lastly, this artifact includes basic error handling. While this is not a big application, inputs are checked and handled correctly in case of improper input types or failed file reading. This prevents undefined behavior from compromising the system. More on how I met course outcomes is defined in the course outcomes section below.
...
In this artifact, the communications provided in my code review and the software design document I included in this project contribute to effective communication to different audiences in a professional manner that is technically sound. In this artifact, I utilized computer science tools and techniques like a MongoDB database and API endpoints to securely store and transfer data, reaching the industry goal of secure and accurate data management. This artifact includes security best practices like authentication, authorization, and encryption. Each demonstrates how security was implemented throughout the SDLC. These practices were discussed in the Code Review and planned in the design document. Completing countless tests using Postman ensured that data was being correctly handled and that the JWT authorization worked correctly. Ultimately, the application shows a thorough understanding of security best practices. Any further course outcome information is in the course outcomes section below.
